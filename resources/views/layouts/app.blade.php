...
<body class="font-sans antialiased text-gray-900 bg-gray-50 flex justify-center">
    ...
    <div class="w-full max-w-md min-h-screen bg-white relative shadow-2xl flex flex-col overflow-x-hidden">
        ...
        @auth
            <nav
                ...
                <a href="{{ route('dashboard') }}" wire:navigate
                    ...
                    <span class="text-xs font-semibold">الحومة</span>
                </a>
                <a href="{{ route('messages.index') }}" wire:navigate
                    ...
                    <span class="text-xs font-semibold">تواصل</span>
                </a>
                <a href="{{ route('places.index') }}" wire:navigate
                    ...
                    <span class="text-xs font-semibold">حانوت</span>
                </a>
                <a href="{{ route('profile') }}" wire:navigate
                    ...
                    <span class="text-xs font-semibold">بروفايل</span>
                </a>
            </nav>
        @endauth
        <!-- PWA Install Prompt -->
        <div id="pwa-install-banner" class="hidden fixed bottom-24 left-4 right-4 z-[60] max-w-md mx-auto">
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h4 class="font-bold text-sm font-arabic">نصب التطبيق على تليفونك!</h4>
                        <p class="text-[10px] text-gray-500 font-arabic">باش تدخل للحومة أسرع وبلاش متصفح</p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <button id="pwa-install-btn"
                        class="bg-aljalia-red text-white text-xs font-bold px-4 py-2 rounded-lg font-arabic whitespace-nowrap">تثبيت</button>
        ...
        <div id="ios-install-tip" class="hidden fixed bottom-24 left-4 right-4 z-[60] max-w-md mx-auto">
            <div class="bg-white border border-blue-100 rounded-2xl shadow-2xl p-4 text-right dir-rtl">
                <div class="flex items-center gap-3 justify-between mb-2">
                    ...
                    <h4 class="font-bold text-sm font-arabic">نصب التطبيق على iPhone</h4>
                </div>
                <p class="text-xs text-gray-600 font-arabic leading-relaxed">
